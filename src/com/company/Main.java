...
public class Main {
    ...
    private static void selectConfig(){ // turns 0 to 1 for ship location
        ...
        while (true){
            ...
            switch (userIn) {
                case "1":
                    grid[2][2] = 1;grid[3][2] = 1;grid[4][2] = 1;grid[5][2] = 1;grid[3][4] = 1;
                    grid[3][5] = 1;grid[3][6] = 1;grid[3][7] = 1;grid[3][8] = 1;grid[5][4] = 1;
                    grid[5][5] = 1;grid[5][7] = 1;grid[6][7] = 1;grid[7][7] = 1;grid[7][3] = 1;
                    grid[7][4] = 1;grid[7][5] = 1;
                    break label;
                case "2":
                    grid[0][1] = 1;grid[1][1] = 1;grid[2][1] = 1;grid[3][1] = 1;grid[4][1] = 1;
                    grid[0][4] = 1;grid[0][5] = 1;grid[0][6] = 1;grid[0][8] = 1;grid[0][9] = 1;
                    grid[6][4] = 1;grid[6][5] = 1;grid[6][6] = 1;grid[6][7] = 1;grid[6][0] = 1;
                    grid[7][0] = 1;grid[8][0] = 1;
                    break label;
                case "3":
                    grid[0][7] = 1;grid[0][8] = 1;grid[3][2] = 1;grid[4][2] = 1;grid[5][2] = 1;
                    grid[6][2] = 1;grid[8][3] = 1;grid[8][4] = 1;grid[8][5] = 1;grid[7][9] = 1;
                    grid[8][9] = 1;grid[9][9] = 1;grid[3][4] = 1;grid[3][5] = 1;grid[3][6] = 1;
                    grid[3][7] = 1;grid[3][8] = 1;
                    break label;
                default:
